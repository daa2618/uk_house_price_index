                                ...
                                html.Div(
                                    ...
                                    children=[
                                        ...
                                        dcc.RangeSlider(
                                            ...
                                            marks={
                                                y: {"label": str(y), "style": {"color": "#f0f0f0", "fontSize": "12px"}}
...
for tab_name, mapping in TABS.items():
    ...
    def update_graph(region, plot_choice, year_range, mapping=mapping):
        ...
        fig.update_layout(
            ...
            title=dict(font=dict(size=24, color="#ecf0f1"), x=0.5, y=0.95),
            ...
            legend=dict(bgcolor="rgba(42, 42, 42, 0.8)", bordercolor="rgba(128, 128, 128, 0.5)", borderwidth=1),
        )
